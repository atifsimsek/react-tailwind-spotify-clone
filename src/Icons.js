...
const VolumeFullIcon = ({ size }) => {
    return (
        <svg role="presentation" height={size} width={size} fill="currentColor" aria-hidden="true" aria-label="Ses seviyesi yüksek" id="volume-icon" viewBox="0 0 16 16" data-encore-id="icon" class="Svg-sc-ytk21e-0 uPxdw">
...
const UpArrow = ({ size }) => {
    ...
    return (
        <svg role="img" height={size} width={size} fill="currentColor" aria-hidden="true" viewBox="0 0 16 16" data-encore-id="icon" class="Svg-sc-ytk21e-0 uPxdw"><path d="M.47 11.03a.75.75 0 001.06 0L8 4.56l6.47 6.47a.75.75 0 101.06-1.06L8 2.44.47 9.97a.75.75 0 000 1.06z"></path>
        </svg>
    )
}
