const HomeIcon = ({ size }) => {
    ...
    return (
        <svg role="img" height={size} width={size} aria-hidden="true" fill="currentColor" className="Svg-sc-ytk21e-0 uPxdw home-icon" viewBox="0 0 24 24">
...
const SearchIcon = ({ size }) => {
    ...
    return (
        <svg role="img" height={size} width={size} fill="currentColor" aria-hidden="true" className="Svg-sc-ytk21e-0 uPxdw search-icon" viewBox="0 0 24 24">
...
const CollectionIcon = ({ size }) => {
    ...
    return (
        <svg role="img" height={size} width={size} aria-hidden="true" fill="currentColor" className="Svg-sc-ytk21e-0 uPxdw collection-icon" viewBox="0 0 24 24">
...
const PlusIcon = ({ size }) => {
    return (
        <svg role="img" height={size} width={size} aria-hidden="true" fill="currentColor" viewBox="0 0 16 16" className="Svg-sc-ytk21e-0 uPxdw">
...
const DownlandIcon = ({ size }) => {
    return (
        <svg role="img" height={size} width={size} aria-hidden="true" fill="currentColor" viewBox="0 0 24 24" className="Svg-sc-ytk21e-0 uPxdw">
...
const PrevIcon = ({ size }) => {
    return (
        <svg role="img" height={size} width={size} aria-hidden="true" fill="currentColor" className="Svg-sc-ytk21e-0 kcBZLg IYDlXmBmmUKHveMzIPCF" viewBox="0 0 24 24">
...
const NextIcon = ({ size }) => {
    return (
        <svg role="img" height={size} width={size} aria-hidden="true" fill="currentColor" className="Svg-sc-ytk21e-0 kcBZLg IYDlXmBmmUKHveMzIPCF" viewBox="0 0 24 24"><path d="M8.043 2.793a1 1 0 000 1.414L15.836 12l-7.793 7.793a1 1 0 101.414 1.414L18.664 12 9.457 2.793a1 1 0 00-1.414 0z"></path>
        </svg>
    )
}
...
const DownDirIcon = ({ size }) => {
    return (
        <svg role="img" height={size} width={size} aria-hidden="true" fill="currentColor" className="Svg-sc-ytk21e-0 uPxdw eAXFT6yvz37fvS1lmt6k" viewBox="0 0 16 16">
...
const ExternalIcon = ({ size }) => {
    return (
        <svg role="img" height={size} width={size} aria-hidden="true" fill="currentColor" aria-label="Harici bağlantı" viewBox="0 0 16 16" className="Svg-sc-ytk21e-0 uPxdw">
            <path d="M1 2.75A.75.75 0 011.75 2H7v1.5H2.5v11h10.219V9h1.5v6.25a.75.75 0 01-.75.75H1.75a.75.75 0 01-.75-.75V2.75z"></path><path d="M15 1v4.993a.75.75 0 11-1.5 0V3.56L8.78 8.28a.75.75 0 01-1.06-1.06l4.72-4.72h-2.433a.75.75 0 010-1.5H15z">
...
const PlayIcon = ({ size }) => {
    return (
        <svg role="img" height={size} width={size} aria-hidden="true" viewBox="0 0 24 24" fill="currentColor" className="Svg-sc-ytk21e-0 uPxdw">
...
const DeviceIcon = ({ size }) => {
    return (
        <svg role="presentation" height={size} width={size} aria-hidden="true" fill="currentColor" className="Svg-sc-ytk21e-0 uPxdw" viewBox="0 0 16 16">
...
const PictureInPictureIcon = ({ size }) => {
    return (
        <svg width={size} height={size} xmlns="http://www.w3.org/2000/svg"><g fill="currentColor" fill-rule="evenodd">
            <path d="M1 3v9h14V3H1zm0-1h14a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1z" fill-rule="nonzero"></path><path d="M10 8h4v3h-4z"></path></g>
        </svg>
    )
}
...
const VolumeLowIcon = ({ size }) => {
    return (
        <svg role="presentation" height={size} width={size} aria-hidden="true" fill="currentColor" aria-label="Ses seviyesi düşük" id="volume-icon" viewBox="0 0 16 16" className="Svg-sc-ytk21e-0 uPxdw">
...
const VolumeNormalIcon = ({ size }) => {
    return (
        <svg role="presentation" height={size} width={size} aria-hidden="true" fill="currentColor" aria-label="Ses seviyesi orta" id="volume-icon" viewBox="0 0 16 16" className="Svg-sc-ytk21e-0 uPxdw">
...
const VolumeFullIcon = ({ size }) => {
    return (
        <svg role="presentation" height={size} width={size} fill="currentColor" aria-hidden="true" aria-label="Ses seviyesi yüksek" id="volume-icon" viewBox="0 0 16 16" data-encore-id="icon" className="Svg-sc-ytk21e-0 uPxdw">
...
const UpArrow = ({ size }) => {
    ...
    return (
        <svg role="img" height={size} width={size} fill="currentColor" aria-hidden="true" viewBox="0 0 16 16" data-encore-id="icon" className="Svg-sc-ytk21e-0 uPxdw"><path d="M.47 11.03a.75.75 0 001.06 0L8 4.56l6.47 6.47a.75.75 0 101.06-1.06L8 2.44.47 9.97a.75.75 0 000 1.06z"></path>
        </svg>
    )
}
