...
const FullScreenPlayer = ({ toggle, state, controls, volumeIcon }) => {
    ...
    return (
        <div className='h-full relative' >
            <div className='absolute inset-0 bg-cover object-cover bg-center blur md opacity-30' style={{ backgroundImage: `url(${current.image})` }}></div>
            <div className='flex flex-col items-center w-full absolute bottom-4 pt-2 px-8 '>
